...
```
bash <(curl -s -L https://raw.githubusercontent.com/oooosols/MinerProxy/main/install.sh)
```
...
安装好 wget 之后 下载脚本并执行
```
wget https://raw.githubusercontent.com/oooosols/MinerProxy/main/install.sh
```
```
bash install.sh
```
...
webserver: true 开启web面板填：true 关闭填：false
    - port: "5555" 转发端口
      ...
      clientnum: 0 默认即可
```
# MinerProxy - 联系邮箱 lyl2wxb@gmail.com
